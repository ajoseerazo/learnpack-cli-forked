...
learnpack/0.1.4 darwin-x64 node-v10.17.0
...
_See code: [src/commands/clean.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/clean.js)_
...
_See code: [src/commands/download.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/download.js)_
...
_See code: [src/commands/hello.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/hello.js)_
...
_See code: [src/commands/init.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/init.js)_
...
_See code: [src/commands/login.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/login.js)_
...
_See code: [src/commands/logout.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/logout.js)_
...
_See code: [src/commands/publish.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/publish.js)_
...
_See code: [src/commands/start.js](https://github.com/learnpack/learnpack-cli/blob/v0.1.4/src/commands/start.js)_
<!-- commandsstop -->
